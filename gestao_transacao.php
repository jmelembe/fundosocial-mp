            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_transacao.php?id=<?php echo isset($row['id']) ? htmlspecialchars($row['id']) : ""; ?>" class="btn btn-warning">
                                Editar <i class="fas fa-pen"></i>
                            </a>
                            <a href="apagar_transacao.php?id=<?php echo isset($row['id']) ? htmlspecialchars($row['id']) : ""; ?>" class="btn btn-danger">
