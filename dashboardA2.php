...
<body>
  <div id="mySidebar" class="sidebar">
    ...
    <a href="visualizar_minhacontaA2.php">Minha Conta</a>
    <a href="visualizar_contribuicoes_membroA2.php">Contribuições</a>
    <a href="visualizar_conta_membroA2.php">Detalhes da Conta</a>
    <a href="gestao_transacaoA2.php">Gestão de Transações</a>
    <a href="docs_fs_membroA2.php">Documentos</a>
    <a href="visualizar_graficobA2.php">Gráfico de Barras</a>
    <a href="visualizar_graficocA2.php">Gráfico Circular</a>
    <a href="contactA2.html">Contacte-nos</a>
