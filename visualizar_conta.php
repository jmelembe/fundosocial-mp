...
<body>
    ...
    if (!isset($_SESSION['retiradas'])) {
        $_SESSION['retiradas'] = array("Jan" => 0, "Fev" => 0, "Mar" => 0, "Abr" => 0, "Mai" => 0, "Jun" => 0, "Jul" => 0, "Ago" => 0, "Sept" => 0, "Oct" => 0, "Nov" => 0, "Dez" => 0);
    }

    if (!isset($_SESSION['taxas'])) {
        $_SESSION['taxas'] = array("Jan" => 0, "Fev" => 0, "Mar" => 0, "Abr" => 0, "Mai" => 0, "Jun" => 0, "Jul" => 0, "Ago" => 0, "Sept" => 0, "Oct" => 0, "Nov" => 0, "Dez" => 0);
    }
    ...
    $conn->close();
    ?>
    <button class="btn"><a href="dashboard.php" class="fa fa-close"> </a>Voltar</button>
</body>
