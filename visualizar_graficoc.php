...
<body>
    ...
    <div class="container">
        ...
        <a href="visualizar_graficob.php" class="btn btn-secondary">Grafico de Barras</a>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var dataMembros = google.visualization.arrayToDataTable([
                    ...
                    ["Membros", <?php echo $quantidadeMembros; ?>, "rgba(0, 123, 255, 0.8)"],
                ...
                var dataTransacoes = google.visualization.arrayToDataTable([
                    ["Element", "Density", { role: "style" }],
                    ["Transações", <?php echo $quantidadeTransacoes; ?>, "rgba(255, 99, 132, 0.8)"],
                ...
                var dataTreinos = google.visualization.arrayToDataTable([
                    ["Element", "Density", { role: "style" }],
                    ["Treinos", <?php echo $quantidadeTreinos; ?>, "rgba(255, 206, 86, 0.8)"],
                ...
                var chartMembros = new google.visualization.PieChart(document.getElementById("doughnutChartMembros"));
                chartMembros.draw(dataMembros, options);

                // Configuração do gráfico de transacoes
                var chartTransacoes = new google.visualization.PieChart(document.getElementById("doughnutChartTransacoes"));
                chartTransacoes.draw(dataTransacoes, options);

                // Configuração do gráfico de treinos
                var chartTreinos = new google.visualization.PieChart(document.getElementById("doughnutChartTreinos"));
                chartTreinos.draw(dataTreinos, options);
            }
        </script>

        <div class="container">
            <a href="dashboard__membro.php" class="btn btn-warning"><i class="fas fa-sign-out-alt"></i> Voltar</a>
        </div>
    </div>
</body>
